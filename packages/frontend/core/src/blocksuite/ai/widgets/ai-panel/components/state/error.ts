    ...
    const errorTemplate = choose(
      ...
      [
        [
          ...
          () =>
            html` <div class="error-info">
                You need to login to Katiba Cloud to continue using Katiba AI.
              </div>
        ...
        [
          ...
          () =>
            html` <div class="error-info">
                You've reached the current usage cap for Katiba AI. You can
                subscribe to Katiba AI(with free 7-day-trial) to continue the AI
                experience!
              </div>
              <div class="action-button-group">
                <div @click=${this.config.cancel} class="action-button">
