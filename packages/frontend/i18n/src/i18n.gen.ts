...
export function useAFFiNEI18N(): {
    ...
    /**
      * `Your workspace will be synced and backed up with Katiba Sync.`
      */
    ["Enable AFFiNE Cloud Description"](): string;
    /**
      * `Some features need Katiba Sync. Web workspaces are saved in this browser and may be removed automatically when disk space is low. Enable Katiba Sync to keep this workspace safer and available across devices.`
      */
    ...
    /**
      * `You've got the latest version of Katiba.`
      */
    ...
    /**
      * `Answer questions, draft docs, visualize ideas - Katiba AI can save you time at every possible step. Powered by GPT's most powerful model.`
      */
    ...
    /**
      * `To use Katiba AI, please sign in to your Katiba Cloud account.`
      */
    ...
    /**
      * `Edit all Katiba theme variables here`
      */
    ...
    /**
      * `Customize your Katiba appearance`
      */
    ...
    /**
      * `Display the menubar app in the tray for quick access to Katiba or meeting recordings.`
      */
    ...
    /**
      * `Open Katiba when left‑clicking the tray icon.`
      */
    ...
    /**
      * `Minimize Katiba to the system tray.`
      */
    ...
    /**
      * `Close Katiba to the system tray.`
      */
    ...
    /**
      * `Start Katiba minimized to the system tray.`
      */
    ...
    /**
      * `Congratulations! You have successfully updated the email address associated with your Katiba account.`
      */
    ...
    /**
      * `Requires Katiba desktop app version 0.18 or later.`
      */
    ...
    /**
      * `Welcome to Katiba, you're almost there!`
      */
    ...
    /**
      * `Your password has been updated! You can sign in to Katiba with the new password.`
      */
    ...
    /**
      * `Your password has been saved! You can sign in to Katiba with email and password.`
      */
    ...
    /**
      * `The app will automatically open or redirect to the web version. If you encounter any issues, you can also click the button below to manually open the Katiba app.`
      */
    ...
    /**
      * `You have successfully signed in. The app will automatically open or redirect to the web version. if you encounter any issues, you can also click the button below to  manually open the Katiba app.`
      */
    ...
    /**
      * `Your workspace is saved in this browser. When disk space is low, the browser may remove it automatically. Enable Katiba Sync to keep it safer.`
      */
    ...
    /**
      * `Host by Katiba.Pro, Save, sync, and backup all your data.`
      */
    ...
    /**
      * `Switch to $t(com.Katiba.edgelessMode)`
      */
    ["com.affine.cmdk.switch-to-edgeless"](): string;
    /**
      * `Switch to $t(com.Katiba.pageMode)`
      */
    ...
    /**
      * `Enable Katiba Sync for {{workspaceName}}`
      */
    ...
    /**
      * `Version history can't work with local workspace. Enable Katiba Sync for this workspace to use version history.`
      */
    ["com.affine.history-vision.tips-modal.description"](): string;
    /**
      * `Version history needs Katiba Sync`
      */
    ...
    /**
      * `Import your Bear note backup. Tags will be converted to Katiba tags and folders.`
      */
    ...
    /**
      * `This format importer is available in the Katiba desktop app.`
      */
    ...
    /**
      * `Import your Katiba workspace and page snapshot file.`
      */
    ...
    /**
      * `Import your Katiba db file (.Katiba)`
      */
    ...
    /**
      * `Your document has been imported successfully, thank you for choosing Katiba. Any questions please feel free to feedback to us`
      */
    ...
    /**
      * `Check out Katiba for notes, whiteboards, docs, and AI.`
      */
    ...
    /**
      * `Start Katiba without an account`
      */
    ...
    /**
      * `Katiba Sync keeps your workspace backed up, available across devices, and ready for collaboration and publishing.`
      */
    ["com.affine.nameWorkspace.affine-cloud.description"](): string;
    /**
      * `Sync across devices with Katiba Sync`
      */
    ...
    /**
      * `Enter a link to websites or Katiba docs. Useful for connecting to external resources and referencing internal docs.`
      */
    ...
    /**
      * `Congratulations on your successful purchase of Katiba AI! You're now empowered to refine your content, generate images, and craft comprehensive mindmaps directly within Katiba AI, dramatically enhancing your productivity.`
      */
    ...
    /**
      * `If you end your subscription now, you can still use Katiba AI until the end of this billing period.`
      */
    ...
    /**
      * `Are you sure you want to resume the subscription for Katiba AI? This means your payment method will be charged automatically at the end of each billing cycle, starting from the next billing cycle.`
      */
    ...
    /**
      * `You have purchased Katiba AI. The expiration date is {{end}}.`
      */
    ["com.affine.payment.ai.billing-tip.end-at"](options: {
        readonly end: string;
    }): string;
    /**
      * `You have purchased Katiba AI. The next payment date is {{due}}.`
      */
    ...
    /**
      * `Please tell us more about your use case, to make Katiba better.`
      */
    ...
    /**
      * `Everything in Katiba FOSS & Basic.`
      */
    ...
    /**
      * `We'd like to hear more about where we fall short, so that we can make Katiba better.`
      */
    ...
    /**
      * `Dedicated Discord support with Katiba makers`
      */
    ...
    /**
      * `Upgrade to Katiba Pro for expanded member capacity`
      */
    ...
    /**
      * `You can still use Katiba Cloud Pro until the end of this billing period :)`
      */
    ["com.affine.payment.modal.downgrade.caption"](): string;
    /**
      * `Keep Katiba Cloud Pro`
      */
    ...
    /**
      * `This is the pricing plans of Katiba Cloud. You can sign up or sign in to your account first.`
      */
    ...
    /**
      * `We'd like to hear more about your use case, so that we can make Katiba better.`
      */
    ...
    /**
      * `Congratulations! Your Katiba account has been successfully upgraded to a Pro account.`
      */
    ...
    /**
      * `Thank you for purchasing the Katiba self-hosted license.`
      */
    ...
    /**
      * `Doc analytics over 7 days require an Katiba Team subscription.`
      */
    ...
    /**
      * `Enable the powerful AI assistant, Katiba AI.`
      */
    ...
    /**
      * `Enable Katiba Sync to collaborate with others`
      */
    ...
    /**
      * `Katiba will generate meeting notes by recording your meetings. Authorization to "Screen & System Audio Recording" is necessary.`
      */
    ...
    /**
      * `Use workspace provider keys before Katiba AI plan routes.`
      */
    ...
    /**
      * `Upgrade this workspace to add provider keys and route Katiba AI through your own OpenAI, Anthropic, Gemini, or FAL account.`
      */
    ...
    /**
      * `Available in the Katiba desktop app.`
      */
    ...
    /**
      * `Transcript and workspace indexing require a server Gemini BYOK key or Katiba AI plan fallback.`
      */
    ["com.affine.settings.workspace.byok.warning.transcript"](): string;
    /**
      * `Workspace indexing requires a server Gemini BYOK key or Katiba AI plan fallback.`
      */
    ...
    /**
      * `Choose where the key is stored, then select the models Katiba may use.`
      */
    ...
    /**
      * `Meetings allows you to record and transcribe meetings. Don't forget to enable it in Katiba settings.`
      */
    ...
    /**
      * `Enable Katiba Sync to publish this workspace`
      */
    ...
    /**
      * `Allow Katiba AI Assistant`
      */
    ["com.affine.settings.workspace.affine-ai.label"](): string;
    /**
      * `Allow workspace members to use Katiba AI features. This setting doesn't affect billing. Workspace members use Katiba AI through their personal accounts.`
      */
    ...
    /**
      * `Manage Katiba indexing and Katiba AI Embedding for local content processing`
      */
    ...
    /**
      * `Sharing docs requires Katiba Sync.`
      */
    ...
    /**
      * `Empower your sharing with Katiba Cloud: One-click doc sharing`
      */
    ...
    /**
      * `To ensure compatibility with the updated Katiba client, please upgrade your data by clicking the "Upgrade workspace data" button below.`
      */
    ...
    /**
      * `Failed to turn on Katiba Sync. Please try again.`
      */
    ...
    /**
      * `Import web pages to Katiba`
      */
    ["com.affine.integration.web-clipper.desc"](): string;
    /**
      * `Elevate your Katiba experience with diverse add-ons and seamless integrations.`
      */
    ["com.affine.integration.setting.description"](): string;
    /**
      * `Learn how to develop a integration for Katiba`
      */
    ...
    /**
      * `Manually import your content to Katiba from Readwise`
      */
    ...
    /**
      * `Once disconnected, content will no longer be imported. Do you want to keep your existing highlights in Katiba?`
      */
    ...
    /**
      * `New Readwise highlights will be imported to Katiba `
      */
    ["com.affine.integration.readwise.setting.sync-new-name"](): string;
    /**
      * `New highlights in Readwise will be synced to Katiba `
      */
    ...
    /**
      * `New events will be scheduled in Katiba’s journal`
      */
    ...
    /**
      * `Enabling this setting allows you to connect your calendar events to your Journal in Katiba`
      */
    ...
    /**
      * `Enable other MCP Client to search and read the doc of Katiba.`
      */
    ...
    /**
      * `The server did not respond in time. Katiba will keep trying to reconnect.`
      */
    ...
    /**
      * `This Katiba server is too old for this client. Please upgrade the server to {{requiredVersion}}.`
      */
...
export const TypedTrans: {
    /**
      * `Go to <a>{{link}}</a> for learn more details about Katiba AI.`
      */
    ...
    /**
      * `This is an Katiba server hosted by you or your team. After signing in, workspace data is saved to the Katiba server you enter, not to Katiba Cloud. <1>Learn more about self-hosting.</1>`
      */
    ["com.affine.auth.sign.add-selfhosted.description"]: ComponentType<TypedTransProps<Readonly<{}>, {
        ["1"]: JSX.Element;
    }>>;
    /**
      * `By clicking “Continue with Google/Email” above, you acknowledge that you agree to Katiba's <1>Terms of Conditions</1> and <3>Privacy Policy</3>.`
      */
    ...
    /**
      * `This demo is limited. <1>Download the Katiba Client</1> for the latest features and Performance.`
      */
    ...
    /**
      * `<strong>Where AI meets your meetings - Katiba your collaboration.</strong>
    ...
    /**
      * `Utilize the meeting notes and AI summarization features provided by Katiba. <1>Discuss more in the community</1>.`
      */
    ...
    /**
      * `Import your Readwise highlights to Katiba. Please visit Readwise, <br />click <a>"Get Access Token"</a>, and paste the token below.`
      */
